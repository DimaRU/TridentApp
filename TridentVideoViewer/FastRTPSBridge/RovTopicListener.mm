...
void RovTopicListener::onReaderMatched(eprosima::fastrtps::rtps::RTPSReader* reader,
                                        eprosima::fastrtps::rtps::MatchingInfo& info)
{
    switch (info.status)
    {
        case eprosima::fastrtps::rtps::MATCHED_MATCHING:
            std::cout << "\tMatched:" << topicName << " - " << " guid: " << info.remoteEndpointGuid <<  std::endl;
            n_matched++;
            break;
        case eprosima::fastrtps::rtps::REMOVED_MATCHING:
            std::cout << "\tRemove matched:" << topicName << " - " << " guid: " << info.remoteEndpointGuid << std::endl;
            n_matched--;
            break;
        default:
